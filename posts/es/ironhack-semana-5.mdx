...
![Salir de IronHack a la hora del cierre, actividad poco recomendable](noche)
...
![En IronHack se nos da mejor el software que el hardware](hardware)
...
![Charla de CLEAN CODE y SOLID el lunes, por parte de Juan Gomez](clean_code)
