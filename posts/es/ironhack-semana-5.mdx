...
Como el no tenía una idea definida, acordamos tirar hacia delante con la mía. Vamos a realizar un generador aleatorio de poesía, on line, colaborativo y con sintetizador de voz. Va a estar basado en mi _Reagaetton Generator 1.0_ que puedes ver en replit:

[Regaeton Generator](<https://replit.com/FranciscoBosquet](https://twitter.com/FranciscoBosquet)/RegaetonGeneretor>)

Espero que salga algo muy guapo y con lo que podamos echar unas risas. Y, de paso, dominar de una vez por todas la arquitectura de express y empezar a considerarme a mí mismo un poquito _back-end_.
