...
![Cada un programa como puede...](eneryeti)
...
![Mi lista de deseos en amazon, sin actualizar desde hace un año ¡Ni siquiera quiero esas cosas ya!](amazon)
...
![Selector dinámico de marcas y productos en Want-it](wantit)
...
![Publicaciones tipo polaroid en Want-it](wantit-polaroid)
...
![Detalle de publicación en Want-it](wantit-dell)
...
![Exposición de Emotion por Victor y Mario](emotion)
...
![Mikel presentando Mikescanner](mikescanner)
...
![Participantes del hackshow Ago'2017](hackshow)
