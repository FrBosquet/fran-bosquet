...
![Diagrama de clases para la lógica de IronGunZ](/images/uml.webp)
...
![Dos códigos distintos que hacen lo mismo](/images/kata.webp)
...
![Piskel app, editor de sprites online](/images/piskel.webp)
...
![Fichero de configuración con variables globales disponibles en todo el programa](/images/configjs.webp)
...
![DOM.js mi generador de elementos HTML](/images/domjs.webp)
...
![Brutales IronPizzas en IronHack](/images/telepizza.webp)
...
![IronHacker in the mirror](/images/reflejo.webp)
...
![Tiroteo en IronGunz, notese el aspecto 16bits y el ambiente cyberpunk](/images/irongunz.webp)
...
![Día de las presentaciones del primer proyecto en IronHack](/images/presentacionjuego.webp)
...
![Recibiendo aplausos con mi peor pose](/images/posehorrible.webp)
...
![Seleccionados para competir por el premio al mejor juego](/images/ganadoresjuego.webp)
...
![IronHackers de sabadeo](/images/casaana.webp)
