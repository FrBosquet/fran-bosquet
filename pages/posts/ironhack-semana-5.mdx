...
export const meta = {
	...
	date: (new Date('7-16-2017')).toISOString(),
...
![Salir de IronHack a la hora del cierre, actividad poco recomendable](/images/noche.jpg)
...
![En IronHack se nos da mejor el software que el hardware](/images/hardware.jpg)
...
![Charla de CLEAN CODE y SOLID el lunes, por parte de Juan Gomez](/images/clean_code.jpg)
...
![Buscando momentos ZEN](/images/zen.jpg)
