...
export const meta = {
	...
	date: (new Date('10-9-2017')).toISOString(),
...
> ### Anotación de 2023
>
> Llevo años entrevistando perfiles técnicos, proebas de código y así. Los que son capaces de explicar lo que quieren hacer y lo que están haciendo mientras programan son mucho mas habiles a la hora de mostrar sus habilidades. Si un candidato se queda en silencio durante la prueba, suele ser señal de que no está al nivel requerido.
