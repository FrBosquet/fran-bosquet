...
export const meta = {
	...
	date: (new Date('7-02-2017')).toISOString(),
	tags: ['personal', 'ironhack'],
	image: {
		src: 'irongunzsplash.png',
		author: 'Fran Bosquet',
...
![Diagrama de clases para la lógica de IronGunZ](/images/uml.png)
...
![Dos códigos distintos que hacen lo mismo](/images/kata.png)
...
![Piskel app, editor de sprites online](/images/piskel.png)
...
![Fichero de configuración con variables globales disponibles en todo el programa](/images/configjs.png)
...
![DOM.js mi generador de elementos HTML](/images/domjs.png)
...
![Brutales IronPizzas en IronHack](/images/telepizza.jpg)
...
> ### Anotación de 2023
>
> Este es otro buen ejemplo de buena idea qué se me ocurrio. Es una reimplementacion de un *isKeyDown* que tenemos en muchos engines de videojuegos. Mi juego funcionaba mucho mejor que los demas porque ellos desacomplaron las interacciones del jugador con el renderizado.
...
![IronHacker in the mirror](/images/reflejo.jpg)
...
Ya tenía escenario, jugadores, colisiones. Llegaba lo importante: ¡Que volasen las balas! No tardé demasiado en implementar la creación de las mismas y el vuelo vino solo, dado que heredaban de la clase *posicionable* que mencioné antes, solo tenía que hacer un *update* y moverlas en cada frame.
...
> ### Anotación de 2023
>
> Esto es bastante cierto. Alguno me tenia por un flipado y lo cierto es que ni siquiera me trataba con respeto. Lo de los TAs en IronHack era un tema bastante críticable a mi entender, no se como seguirá ahora. Me explico:
>
> A esta gente, nada mas terminar el bootcamp, los mantenian ahí ya no como alumno sino como profesor asistente. Se daban de alta de autonomos y cobraban algo así como 2000 euros brutos creo recordar. El caso es que el hecho de verse en el mismo ambiente en el que ellos eran clientes una semana antes quizas les impedía ver que habian pasado a prestar un servicio caro de cojones.
>
> Y claro, pagar 6500 (creo que ya va por 7500) euros para que tus dudas las resuelva un imbecil, maleducado o directamente ignorante que encima se da infulas pues no es agradable. No lo digo por todos los TAs que yo tuve, pero ví casos de una pobreza profesional bastante lamentable.
...
![Tiroteo en IronGunz, notese el aspecto 16bits y el ambiente cyberpunk](/images/irongunz.png)
...
![Día de las presentaciones del primer proyecto en IronHack](/images/presentacionjuego.jpg)
...
![Recibiendo aplausos con mi peor pose](/images/posehorrible.jpg)
...
![Seleccionados para competir por el premio al mejor juego](/images/ganadoresjuego.png)
...
![IronHackers de sabadeo](/images/casaana.png)
