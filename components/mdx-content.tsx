...
const mdxComponents = {
  ...
  img: (props: any) => <Image width={700} height={400} className="w-auto mb-1 m-auto" title={props.alt} placeholder='blur' blurDataURL={`/images/placeholder/${props.src}.webp`} alt={props.alt} src={`/images/${props.src}.webp`} />,
