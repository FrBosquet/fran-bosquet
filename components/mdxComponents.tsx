...
const h2 = (props: HTMLAttributes<HTMLHeadingElement>) => <h2 className='text-lg font-medium text-violet-300 mt-4 mb-2'>{props.children}</h2>
const h3 = (props: HTMLAttributes<HTMLHeadingElement>) => <h3 className='text-md text-violet-200 mt-4 mb-1 '>{props.children}</h3>
